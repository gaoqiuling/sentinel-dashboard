...
import com.alibaba.csp.sentinel.dashboard.repository.apollo.FlowRuleApolloProvider;
import com.alibaba.csp.sentinel.dashboard.repository.apollo.FlowRuleApolloPublisher;
...
//    private SentinelApiClient sentinelApiClient;
    ...
    @Autowired
    private FlowRuleApolloProvider ruleProvider;
    @Autowired
    private FlowRuleApolloPublisher rulePublisher;
...
//            List<FlowRuleEntity> rules = sentinelApiClient.fetchFlowRuleOfMachine(app, ip, port);
            List<FlowRuleEntity> rules = ruleProvider.setAppId(app).getRules(app);
...
//        return sentinelApiClient.setFlowRuleOfMachineAsync(app, ip, port, rules);
        ...
        rulePublisher.setAppId(app).publish(app, rules);
    }
}
